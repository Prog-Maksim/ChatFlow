...
public interface IProfileRepository
{
    ...
    /// <returns></returns>
    public Task CreatePersonAsync(DataPersons person);
    ...
    /// <param name="personId">Идентификатор пользователя</param>
    /// <returns></returns>
    public Task<Models.Other.DataPerson?> GetPersonDataAsync(string personId);
    ...
    public Task<DataPersons?> CheckTagAsync(string tag);
